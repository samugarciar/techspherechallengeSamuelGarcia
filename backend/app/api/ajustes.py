...
de una llamada: la frase siguiente ya sale con la otra voz. Este router es la
puerta HTTP a lo que `app/voice/voice_mode.py` ya resuelve; no duplica ninguna
regla, ni siquiera la validación del modo.
